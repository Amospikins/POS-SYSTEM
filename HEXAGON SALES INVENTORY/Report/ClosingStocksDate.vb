...
Public Class ClosingStocksDate
    ...
    Private Sub datatotalStock()
        Try
            ...
            '   lbltransactionno.Text = "Number of Items: " & DataGridView1.Rows.Count
    ...
    Private Sub loadDataclosingstockBYDATE()
        ...
        da.SelectCommand.Parameters.Add("@dt", OleDbType.Date).Value = clostock.DateTimePicker1.Value.Date
        da.SelectCommand.Parameters.Add("@dh", OleDbType.Date).Value = clostock.DateTimePicker2.Value.Date
        da.Fill(dt)
        DataGridView1.DataSource = dt.DefaultView
        cnn1.Close()
    End Sub
    Private Sub ClosingStocksDate_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        lblperiod.Text = "Period: " & clostock.DateTimePicker1.Text & "  to  " & clostock.DateTimePicker2.Text
    End Sub
