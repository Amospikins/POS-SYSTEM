...
Public Class Items
    ...
    Private Sub loadData()
        Try
            ...
            da.SelectCommand.Parameters.Add("@dt", OleDbType.Date).Value = Report_Period2.DateTimePicker1.Value.Date
            da.SelectCommand.Parameters.Add("@dh", OleDbType.Date).Value = Report_Period2.DateTimePicker2.Value.Date
            da.Fill(dt)
    ...
    Private Sub Items_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        loadData()
        lblperiod.Text = "Period: " & Report_Period2.DateTimePicker1.Text & "  to  " & Report_Period2.DateTimePicker2.Text
        datatotalStock()
    End Sub
