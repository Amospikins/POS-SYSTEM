...
Public Class Payment_Method_Report
    ...
    Private Sub datatotalStock()
        Try
            ...
            lbltransactionno.Text = "Number of Staff: " & DataGridView1.Rows.Count
    ...
    Private Sub loadData()
        Try
            ...
            da.SelectCommand.Parameters.Add("@dt", OleDbType.Date).Value = Report_Period3.DateTimePicker1.Value.Date
            da.SelectCommand.Parameters.Add("@dh", OleDbType.Date).Value = Report_Period3.DateTimePicker2.Value.Date
            da.Fill(dt)
        ...
        End Try
    End Sub
    Private Sub Payment_Method_Report_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        cnn.ConnectionString = "Provider=Microsoft.Jet.Oledb.4.0; Data Source=" & Application.StartupPath & "\DB.mdb"
        loadData()
        lblperiod.Text = "Period: " & Report_Period3.DateTimePicker1.Text & "  to  " & Report_Period3.DateTimePicker2.Text
        datatotalStock()
    End Sub
