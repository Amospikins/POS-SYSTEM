...
Public Class Sales_People
    ...
    Private Sub loadData()
        Try
            ...
            da.SelectCommand.Parameters.Add("@dt", OleDbType.Date).Value = Report_period1.DateTimePicker1.Value.Date
            da.SelectCommand.Parameters.Add("@dh", OleDbType.Date).Value = Report_period1.DateTimePicker2.Value.Date
            da.Fill(dt)
        ...
        End Try
    End Sub
    Private Sub Sales_People_Load(sender As Object, e As EventArgs) Handles MyBase.Load
       
        cnn.ConnectionString = "Provider=Microsoft.Jet.Oledb.4.0; Data Source=" & Application.StartupPath & "\DB.mdb"
        loadData()
        lblperiod.Text = "Period: " & Report_period1.DateTimePicker1.Text & "  to  " & Report_period1.DateTimePicker2.Text
        datatotalStock()
    End Sub
