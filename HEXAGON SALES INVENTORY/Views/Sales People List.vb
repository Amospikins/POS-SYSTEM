...
Public Class Sales_People_List
    ...
    Private Sub loadData1()
        Try
            ...
            Dim sqlText = "select DISTINCT StaffName as [Staff Name], SUM(TotalAmount) as [Total Amount] from Receipt group by StaffName"
            Dim da As New OleDbDataAdapter(sqlText, cnn)
            da.Fill(dt)
            DataGridView1.DataSource = dt.DefaultView
            cnn.Close()
        ...
        End Try
    End Sub
    Private Sub Sales_People_List_Load(sender As Object, e As EventArgs) Handles MyBase.Load
