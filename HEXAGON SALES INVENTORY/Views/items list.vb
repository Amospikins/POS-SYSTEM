...
Public Class items_list
    ...
    Private Sub loadData()
        Try
            ...
            ds.Tables.Add(dt)
            Dim sqlText = "select DISTINCT Item_Code as [Item Code], SUM(Qty) as [Quantity], SUM(TotalAmount) as [Total Amount] from TDetails where Dates between @dt and @dh group by Item_Code"
    ...
    Private Sub loadData1()
        Try
            ...
            Dim dt As New DataTable
            ds.Tables.Add(dt)
            Dim sqlText = "select DISTINCT Item_Code as [Item Code], SUM(Qty) as [Quantity], SUM(TotalAmount) as [Total Amount] from TDetails group by Item_Code"
            Dim da As New OleDbDataAdapter(sqlText, cnn)
            da.Fill(dt)
            DataGridView1.DataSource = dt.DefaultView
            cnn.Close()
        ...
        End Try
    End Sub
    Private Sub items_list_Load(sender As Object, e As EventArgs) Handles MyBase.Load
